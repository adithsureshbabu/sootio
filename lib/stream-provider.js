      ...
      if (service.provider === 'Usenet') {
        ...
        if (use4KHDHub) {
          addStreamTask(
            ...
            { provider: '4KHDHub', ...earlyReturnMeta }
          );
        }
        ...
        if (useHDHub4u) {
          addStreamTask(
            ...
            { provider: 'HDHub4u', ...earlyReturnMeta }
          );
        }
        ...
        if (useMKVCinemas) {
          addStreamTask(
            ...
            { provider: 'MKVCinemas', ...earlyReturnMeta }
          );
        }
        ...
        if (useMkvDrama) {
          addStreamTask(
            ...
            { provider: 'MkvDrama', ...earlyReturnMeta }
          );
        }
        ...
        if (useCineDoze) {
          addStreamTask(
            ...
            { provider: 'CineDoze', ...earlyReturnMeta }
          );
        }
        ...
        if (useMalluMv) {
          addStreamTask(
            ...
            { provider: 'MalluMv', ...earlyReturnMeta }
          );
        }
        ...
        if (useUHDMovies) {
          addStreamTask(
            ...
            { provider: 'UHDMovies', ...earlyReturnMeta }
          );
        }
        ...
        if (useMoviesDrive) {
          addStreamTask(
            ...
            { provider: 'MoviesDrive', ...earlyReturnMeta }
          );
        }
        ...
        if (useVixSrc) {
          addStreamTask(
            ...
            { provider: 'VixSrc', ...earlyReturnMeta }
          );
        }
