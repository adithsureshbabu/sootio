        ...
        .then(async response => {
            ...
            if (!downloadBtn || downloadBtn.length === 0) {
                ...
                if (!foundBtn || foundBtn.length === 0) {
                    ...
                    return processHubDriveLink(preferredLink.href);
                }
...
export function processHubDriveLink(href) {
    ...
    // Check if it's another HubDrive link - recurse
    else if (hrefLower.includes('hubdrive')) {
        console.log('HubDrive link is another HubDrive page, recursing...');
        return extractHubDriveLinks(href);
    }
    else {
