...
async function fetchPage(url, signal = null) {
    ...
    try {
        ...
        // Clear cached cookies if they didn't work (got 403/429 or CF challenge)
        const gotBlocked = isCloudflareBlocked || response.statusCode === 403 || response.statusCode === 429;
        ...
        const needsFlareSolverr = isCloudflareBlocked ||
            ((response.statusCode === 403 || response.statusCode === 429) && !usedCachedCookie);
