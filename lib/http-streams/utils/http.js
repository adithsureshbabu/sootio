...
export function makeRequest(url, options = {}) {
    ...
    const MAX_RETRIES = parseInt(process.env.REQUEST_MAX_RETRIES) || 1; // 1 retry by default
    const RETRY_DELAY = parseInt(process.env.REQUEST_RETRY_DELAY) || 800; // 0.8 second delay
