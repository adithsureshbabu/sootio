...
import { getCachedHashes as sqliteGetCachedHashes, upsertCachedMagnet as sqliteUpsert, default as sqliteCache } from './util/cache-store.js';
...
async function resolveStream(apiKey, urlToResolve, type, id) {
    ...
    const resolverPromise = (async () => {
        ...
        // If still not found, add to Offcloud (single attempt per key)
