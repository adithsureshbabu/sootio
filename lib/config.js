...
export const LIMETORRENTS_URL = process.env.LIMETORRENTS_URL || 'https://www.limetorrents.fun';
...
export const BTDIG_PROXY = process.env.BTDIG_PROXY || '';
...
export const LIMETORRENTS_LIMIT = parseInt(process.env.LIMETORRENTS_LIMIT, 10) || 100;
export const LIMETORRENTS_MAX_PAGES = parseInt(process.env.LIMETORRENTS_MAX_PAGES, 10) || 3;
export const LIMETORRENTS_TIMEOUT = parseInt(process.env.LIMETORRENTS_TIMEOUT, 10) || 10000;
...
export const LIMETORRENTS_ENABLED = process.env.LIMETORRENTS_ENABLED === 'true';
